...
os.makedirs("checkpoints/vanilla_gan", exist_ok=True)
...
# Save models
torch.save(generator.state_dict(), "checkpoints/vanilla_gan/generator.pth")
torch.save(discriminator.state_dict(), "checkpoints/vanilla_gan/discriminator.pth")

# Save loss curve
plot_loss_curve(g_losses, d_losses, "results/loss_curves/vanilla_gan_loss.png")
